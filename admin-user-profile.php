...
$swal = ""; // unified SweetAlert handler
...
<head>
  ...
  <style>
    /* 🌿 Uniform Design (same as Faculty and Superadmin) */
    body {
      background: #f8fafc;
    }
                ...
                <div class="tab-pane fade show active" id="profile-edit">
                  <form method="POST">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9"><input type="text" class="form-control text-capitalize" readonly value="<?= htmlspecialchars($program_display) ?>"></div>
                    </div>
                    <div class="row mb-3">
