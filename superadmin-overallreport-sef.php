              ...
              <div class="card-body">
                ...
                <?php if (!empty($selected_college)) { ?>
                  ...
                  <div class="text-end mb-3">
                    <a href="superadmin-overallreport-sef-print.php?college=<?= urlencode($selected_college) ?>&program=<?= urlencode($selected_program) ?>&semester=<?= urlencode($selected_semester) ?>&academic_year=<?= urlencode($selected_academic_year) ?>"
