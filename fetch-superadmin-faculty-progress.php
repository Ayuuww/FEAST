...
$faculty_id = $_SESSION['idnumber']; // superadmin is also faculty
...
// Get all subjects handled by this superadmin (as faculty)
...
while ($subject = $subjectQuery->fetch_assoc()) {
    ...
    // Total students enrolled in subject
  ...
  ");
    ...
    // Students who completed evaluation
