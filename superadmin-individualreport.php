    ...
    <main id="main" class="main">
      ...
      <div class="card p-4 mb-4">
        ...
        if (isset($_GET['faculty_id'])) {
            ...
            // ===========================
            $result = mysqli_query($conn, " SELECT e.subject_code, e.student_section, f.department,
                                            COUNT(*) AS num_students,
                                            AVG(e.computed_rating) AS avg_rating
                                      FROM evaluation e
                                      JOIN faculty f ON f.idnumber = e.faculty_id
                                      WHERE e.faculty_id = '$faculty_id'
                                      GROUP BY e.subject_code, f.department, e.student_section ");
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                $section_display = $row['department'] . $row['student_section'];
            ...
            <table class="table table-bordered">
                ...
                <tr><th>Semester/Term & Academic Year:</th><td><?= htmlspecialchars($semester) ?> / <?= htmlspecialchars($academic_year) ?></td></tr>
            </table>
