...
// Fetch profile data
$stmt = $conn->prepare("SELECT first_name, mid_name, last_name, role, faculty_rank, position, college, program FROM superadmin WHERE idnumber = ?");
                ...
                <div class="tab-pane fade show active pt-3" id="profile-edit">
                  <form method="POST">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9 position-relative">
                        <input name="college" type="text" class="form-control text-capitalize"
                          value="<?= htmlspecialchars($data['college']) ?>"
