...
$navItems = [
    'superadmin' => [
        ...
        ['name' => 'College Report SET', 'link' => 'superadmin-overallreport-set.php'],
        ['name' => 'College Report SEF', 'link' => 'superadmin-overallreport-sef.php'],
        ['name' => 'College Report (SET & SEF)', 'link' => 'superadmin-overallreport.php'],
        ...
        ['name' => 'Evaluated Subject', 'link' => 'superadmin-evaluatedsubject.php'],
