      ...
      <div class="card">
        <div class="card-body table-responsive">
          ...
          <?php if ($result && $result->num_rows): ?>
            <a href="faculty-pastrecords-print.php?academic_year=<?= urlencode($academic_year) ?>&semester=<?= urlencode($semester) ?>&subject_code=<?= urlencode($subject_code) ?>" target="_blank" class="btn btn-outline-secondary mb-3">
